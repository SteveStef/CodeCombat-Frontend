...
const Header = (props) => {
  // make a function to change the query parameter
  //
      ...
      <nav className="bg-gray-700 border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" onClick={() => logout("login")}>{!props.user ? "log in" : "logout"}</a>
          ...
          <div className="hidden lg:flex lg:items-center lg:w-auto" id="mobile-menu">
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <a href="#" className="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0" onClick={() => changePage("username")}>My Profile</a>
              </li>
              <li>
                <a href="#" className="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0" onClick={() => changePage("leaderboard")}>Leaderboards</a>
              </li>
            </ul>
          </div>
        </div>
