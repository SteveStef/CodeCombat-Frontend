        ...
        <div className="bg-white dark:bg-gray-700 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
          <div className="flex flex-row items-center justify-between">
            <div className="mb-4 flex justify-center">
              ...
              <h1 className="text-center text-xl font-bold text-gray-900 dark:text-white">Steve Stef</h1>
            </div>
          ...
          <div className="mb-4 flex justify-center">
            ...
            <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded shadow-md" style={{width: "100%", height: "220px"}}>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Stats</h2>
